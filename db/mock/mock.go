...
type MockRepository struct {
	...
	MockUpdateUserName  func(id int, user *model.User) (model.User, error)
...
func (m *MockRepository) UpdateUserName(id int, user *model.User) (model.User, error) {
	return m.MockUpdateUserName(id, user)
}
